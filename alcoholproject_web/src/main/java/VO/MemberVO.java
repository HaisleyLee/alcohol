...
public class MemberVO {
	...
	String mem_phone	            ;
	String mem_card	                ;
	Date   mem_event_dt_brew        ;
	Date   mem_event_dt_mini        ;
	...
	public int getMem_body() {
		return mem_body;
	}
	public void setMem_body(int mem_body) {
		this.mem_body = mem_body;
	}
	public int getMem_alcohol_type() {
		return mem_alcohol_type;
	}
	public void setMem_alcohol_type(int mem_alcohol_type) {
		this.mem_alcohol_type = mem_alcohol_type;
	}
	public int getMem_flavor() {
		return mem_flavor;
	}
	public void setMem_flavor(int mem_flavor) {
		this.mem_flavor = mem_flavor;
	}
	public int getMem_smell() {
		return mem_smell;
	}
	public void setMem_smell(int mem_smell) {
		this.mem_smell = mem_smell;
	}
	public int getMem_alcohol_bv() {
		return mem_alcohol_bv;
	}
	public void setMem_alcohol_bv(int mem_alcohol_bv) {
	...
	/*
	 * public int getMem_kakao_id() { return mem_kakao_id; } public void
	 * setMem_kakao_id(int mem_kakao_id) { this.mem_kakao_id = mem_kakao_id; }
	 */
	...
	/*
	 * public int getMem_naver_id() { return mem_naver_id; } public void
	 * setMem_naver_id(int mem_naver_id) { this.mem_naver_id = mem_naver_id; }
	 */
	...
	public Date getMem_event_dt_brew() {
		return mem_event_dt_brew;
	}
	public void setMem_event_dt_brew(Date mem_event_dt_brew) {
		this.mem_event_dt_brew = mem_event_dt_brew;
	}
	public Date getMem_event_dt_mini() {
		return mem_event_dt_mini;
	}
	public void setMem_event_dt_mini(Date mem_event_dt_mini) {

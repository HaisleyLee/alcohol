...
public class Al_Info_VO {
	int al_id;
    String  al_name, al_manufacturer, al_material, 
    		al_vol, al_body, al_alcohol_type, al_flavor, al_smell,
    		al_alcohol_bv, al_real_alcohol_bv, al_imgname, al_imgpath,
            al_mini_have, al_mini_vol, al_mini_imgname, al_mini_imgpath;
	...
	public String getAl_alcohol_bv() {
		return al_alcohol_bv;
	}

	public void setAl_alcohol_bv(String al_alcohol_bv) {
    ...
    public String getAl_body() {
        return al_body;
    }

    public void setAl_body(String al_body) {
        this.al_body = al_body;
    }

    public String getAl_alcohol_type() {
        return al_alcohol_type;
    }

    public void setAl_alcohol_type(String al_alcohol_type) {
        this.al_alcohol_type = al_alcohol_type;
    }

    public String getAl_flavor() {
        return al_flavor;
    }

    public void setAl_flavor(String al_flavor) {
        this.al_flavor = al_flavor;
    }

    public String getAl_smell() {
        return al_smell;
    }

    public void setAl_smell(String al_smell) {
    ...
    public String al_alcohol_bv() {
    	return al_alcohol_bv;
    }
    
    public void al_alcohol_bv(String al_alcohol_bv) {
    	this.al_alcohol_bv = al_alcohol_bv;
    }

...
public class TodaysTestVO {
        String todays_id, todays_taste, todays_q, todays_a, todays_a_result, todays_b, todays_b_result, todays_ref;
        ...
        public String getTodays_a_result() {
            return todays_a_result;
        }

        public void setTodays_a_result(String todays_a_result) {
        ...
        public String getTodays_b_result() {
            return todays_b_result;
        }

        public void setTodays_b_result(String todays_b_result) {
